    ...
    <fieldset style="margin-top:70px; margin-left:200px; width=100%">
        <table class="nav-justified" style="width:90%">
            ...
            <tr>
                ...
                <td style="width:400px"><asp:TextBox ID="txtEmail" runat="server" TextMode="Email" Width="350px" Enabled="False"></asp:TextBox></td>
                <td style="width:400px"><asp:Button class="w3-teal" ID="btnSendEmail" runat="server" Text="SEND ME MY PASSWORD" width="300px" OnClick="btnSendEmail_Click" Enabled="False"/></td>
            </tr>
            <tr>
                <td style="width: 80px">&nbsp;</td>
            </tr>
